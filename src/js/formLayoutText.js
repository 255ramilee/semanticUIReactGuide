...
const formExample = () => {
    ...
    const guideTxt1 = [
        ...
        {id:2, msg:(
            <span>
                <img src="../img/logo.svg" onError="../img/fin.png" alt="test" />
            </span>
        )},
        {id:3, msg:"브라우저 지원 범위 : 최신 chrome, Edge, firefox, opera 브라우저 / IE 11 ~"},
        {id:4, msg:"기본 레이아웃 이외의 배치가 필요한 화면은 퍼블리셔에게 문의한다."},
